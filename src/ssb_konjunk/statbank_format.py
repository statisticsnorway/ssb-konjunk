...
def format_time_period(df:pd.DataFrame, year:int, quarter:int|str='', col_name:str='periode') -> pd.DataFrame:
...
def remove_suppressed_numbers(df: pd.DataFrame, colname_value:str, colname_suppressed:str = 'prikka') -> pd.DataFrame:
